...
public class T004_Assert_TextLinks_HomePage {
	...
	/**
	 * Test to assert the header links on homepage 1) user navigates to the home
	 * page 2) asserts the links/tabs on the header are clickable
	 * 
	 * @throws IOException
	 * @throws InterruptedException
	 */
	@Test
	public void assert_Header_HomePage() throws IOException,
